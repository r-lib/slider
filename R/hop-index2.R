...
#' }
#'
#' \subsection{`hop_index2_vec()` and `hop_index2_*()` variants}{
#'
...
#' }
#'
#' \subsection{`phop_index_vec()` and `phop_index_*()` variants}{
#'
