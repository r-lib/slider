...
loop_bounded <- function(x, i, f, params, range_params, split, ...) {
  ...
  while(params$position_index <= params$n_index) {
    ...
    range_params$start_ahead <- start_aheads[[params$position_index]]
    range_params$stop_behind <- stop_behinds[[params$position_index]]
