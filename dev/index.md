...
example, [`slide()`](https://slider.r-lib.org/dev/reference/slide.md)
has [`slide_dbl()`](https://slider.r-lib.org/dev/reference/slide.md),
[`slide2()`](https://slider.r-lib.org/dev/reference/slide2.md), and
[`pslide()`](https://slider.r-lib.org/dev/reference/slide2.md), along
...
[`slide_dbl()`](https://slider.r-lib.org/dev/reference/slide.md) for the
...
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) handles
...
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) iterates
over data frames in a row wise fashion. Interestingly this means the
default of [`slide()`](https://slider.r-lib.org/dev/reference/slide.md)
becomes a generic row wise iterator, with nice syntax for accessing data
frame columns.
...
window that [`slide()`](https://slider.r-lib.org/dev/reference/slide.md)
provides. You can use
[`slide_index()`](https://slider.r-lib.org/dev/reference/slide_index.md)
to pass in both `.x` and an index, `.i`, and the window will be
calculated relative to that index.

Here, when computing a “2 day window”, you probably don’t want
`"2019-08-16"` and `"2019-08-18"` to be grouped together.
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) has no
concept of an index, so when you specify a window size of 2, it will
group these two together.
[`slide_index()`](https://slider.r-lib.org/dev/reference/slide_index.md),
on the other hand, will do the right thing.
...
is different from
[`slide_index()`](https://slider.r-lib.org/dev/reference/slide_index.md)
in that it first breaks the index into “time blocks” and then slides
over `.x` relative to those blocks. For example, in the monthly period
slide below, `i` is broken up into 4 time blocks of “the current block
of monthly data, plus one block before this one”. The locations of those
...
- With [`slide_vec()`](https://slider.r-lib.org/dev/reference/slide.md)
  you can return any kind of object, and are not limited to the suffixed
...
[`slider::slide()`](https://slider.r-lib.org/dev/reference/slide.md).
...
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) and
[`slide_index()`](https://slider.r-lib.org/dev/reference/slide_index.md),
