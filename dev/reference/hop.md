...
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) (at least
in theory). It has slightly different invariants than
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md), and is
useful when you either need to hand craft boundary locations, or want to
...
Because of this,
[`hop_index()`](https://slider.r-lib.org/dev/reference/hop_index.md) is
...
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md). It is
always possible to construct a `hop()` call from a
[`slide()`](https://slider.r-lib.org/dev/reference/slide.md) call. For
