...
- New
  [`slider_plus()`](https://slider.r-lib.org/dev/reference/index-arithmetic.md)
  and
  [`slider_minus()`](https://slider.r-lib.org/dev/reference/index-arithmetic.md)
...
- New vignette,
  [`vignette("tsibble")`](https://slider.r-lib.org/dev/articles/tsibble.md),
  explaining how to transition from tsibble to slider
  ([\#128](https://github.com/r-lib/slider/issues/128)).

- [`vignette("rowwise")`](https://slider.r-lib.org/dev/articles/rowwise.md)
...
- As a followup to a change in slider 0.1.3, edge cases with size zero
  input in [`hop()`](https://slider.r-lib.org/dev/reference/hop.md) have
  also been fixed.
...
- [`hop()`](https://slider.r-lib.org/dev/reference/hop.md) and its
  variants no longer place the names of `.x` on the output. Because
  there is no *size* guarantee on the output, the size of `.x` can be
  different than the size of the output, meaning that the names might
  not line up. This also affects
  [`slide_period()`](https://slider.r-lib.org/dev/reference/slide_period.md),
  which is implemented using a
  [`hop()`](https://slider.r-lib.org/dev/reference/hop.md) variant
  ([\#75](https://github.com/r-lib/slider/issues/75)).

- With data frames containing row names,
  [`slide()`](https://slider.r-lib.org/dev/reference/slide.md) and its
