...
[`pslide()`](https://slider.r-lib.org/reference/slide2.md) with
[`hop()`](https://slider.r-lib.org/reference/hop.md), allowing you to
iterate over multiple vectors at once, hopping along them using
