...
[`slide()`](https://slider.r-lib.org/reference/slide.md) is generally
used. Notably, `slide_sum()` can be used for rolling sums, and
...
[`slide_dbl()`](https://slider.r-lib.org/reference/slide.md) or
[`slide_lgl()`](https://slider.r-lib.org/reference/slide.md), especially
with a very wide window.
